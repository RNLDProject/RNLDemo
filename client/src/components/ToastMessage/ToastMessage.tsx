...
const ToastMessage: FC<ToastMessageProps> = ({
  ...
  return (
    <>
      <div
        className={`fixed top-40 right-0 md:right-4 z-50 flex items-center w-full max-w-xs p-4 mb-4 text-black rounded-lg shadow-lg transition-opacity duration-300 ${
      ...
      >
        ...
        >
          ...
          <span className="sr-only">{isFailed ? "Error icon" : "Check icon"}</span>
        </div>
